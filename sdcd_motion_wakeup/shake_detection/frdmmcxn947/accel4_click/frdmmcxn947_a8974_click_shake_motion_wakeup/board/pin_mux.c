...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port5_7_config = {/* Internal pull-up/down resistor is disabled */
    												 kPORT_PullUp,
                                                     /* Low internal pull resistor value is selected. */
													 kPORT_HighPullResistor,
                                                     /* Fast slew rate is configured */
                                                     ...
                                                     kPORT_UnlockRegister};
    /* PORT0_29 (pin F8) is configured as PIO0_29 */
    PORT_SetPinConfig(PORT5, 7U, &port5_7_config);

    /* FXLS8974CF INTF_SEL Pin */
    const port_pin_config_t port1_21_config      = {/* Internal pull-up/down resistor is disabled */
													kPORT_PullDisable,
													/* Low internal pull resistor value is selected. */
													...
													/* Pin Control Register fields [15:0] are not locked */
													kPORT_UnlockRegister};
    /* PORT1_21 is configured */
    PORT_SetPinConfig(PORT1, 21U, &port1_21_config);

    /* FXLS8974CF BT_MODE Pin */
    const port_pin_config_t port1_2_config        = {/* Internal pull-up/down resistor is disabled */
													kPORT_PullDisable,
													/* Low internal pull resistor value is selected. */
													kPORT_LowPullResistor,
													/* Fast slew rate is configured */
													...
													/* Pin Control Register fields [15:0] are not locked */
													kPORT_UnlockRegister};
    /* PORT1_2 is configured */
    PORT_SetPinConfig(PORT1, 2U, &port1_2_config);
    ...
    const port_pin_config_t port4_12_pinT6_config = {/* Internal pull-up/down resistor is disabled */
                                                     ...
                                                     /* Pin Control Register fields [15:0] are not locked */
                                                     kPORT_UnlockRegister};
    /* PORT4_12 (pin T6) is configured as P4_12 */
...
void LPI2C3_DeinitPins(void)
{
    ...
    const port_pin_config_t port1_0_pinC6_config = {/* Internal pull-up/down resistor is disabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORT1_0 is configured as PIO1_0 */
    PORT_SetPinConfig(PORT1, 0U, &port1_0_pinC6_config);
    ...
    const port_pin_config_t port1_1_pinC5_config = {/* Internal pull-up/down resistor is disabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORT1_1 is configured as PIO1_1 */
    PORT_SetPinConfig(PORT1, 1U, &port1_1_pinC5_config);
}
