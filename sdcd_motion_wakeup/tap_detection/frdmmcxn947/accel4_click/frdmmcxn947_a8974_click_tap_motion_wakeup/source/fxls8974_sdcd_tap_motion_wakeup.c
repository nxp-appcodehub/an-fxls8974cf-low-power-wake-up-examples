...
/**
 * @file  fxls8974_click_tap_motion_wakeup.c
 *  @brief The fxls8974_click_tap_motion_wakeup.c file implements the ISSDK FXLS8974CF sensor
 *         example demonstrating SDCD configuration for tap-motion wake-up and enabling
 *         auto-wake/sleep (AWS).
 */
...
const registerwritelist_t cFxls8974TapAwsConfig[] = {
    /* Set Full-scale range as 4G. */
    {FXLS8974_SENS_CONFIG1, FXLS8974_SENS_CONFIG1_FSR_4G, FXLS8974_SENS_CONFIG1_FSR_MASK},
    /* Set Wake ODR as 100Hz & Sleep Mode ODR as 25Hz. */
    {FXLS8974_SENS_CONFIG3, FXLS8974_SENS_CONFIG3_WAKE_ODR_100HZ | FXLS8974_SENS_CONFIG3_WAKE_ODR_25HZ, FXLS8974_SENS_CONFIG3_WAKE_ODR_MASK | FXLS8974_SENS_CONFIG3_SLEEP_ODR_MASK},
	...
	{FXLS8974_SDCD_LTHS_LSB, 0xFF, 0},
	{FXLS8974_SDCD_LTHS_MSB, 0xFB, 0},
	{FXLS8974_SDCD_UTHS_LSB, 0x01, 0},
	{FXLS8974_SDCD_UTHS_MSB, 0x04, 0},
	...
	{FXLS8974_ASLP_COUNT_LSB, 0x80, 0},
	{FXLS8974_ASLP_COUNT_MSB, 0x00, 0},
...
int main(void)
{
    ...
    status = FXLS8974_I2C_Configure(&fxls8974Driver, cFxls8974TapAwsConfig);
